...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_do__ = __webpack_require__(114);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_photo_viewer__ = __webpack_require__(208);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = (function () {
    ...
    LoginPage.prototype.fbLogin = function () {
        var res = this.authService.fbLogin();
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__pages_list_list__["a" /* ListPage */], { userData: res });
    };
    LoginPage.prototype.login = function () {
        ...
        this.authService.login(userData).then(function (result) {
            if (result.success) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_facebook__ = __webpack_require__(210);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_do__ = __webpack_require__(114);
...
var AuthServiceProvider = (function () {
    function AuthServiceProvider(keyboard, fb, storage, http, event, menuCtrl, alertCtrl) {
    ...
    AuthServiceProvider.prototype.signup = function (userData) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (userData.username == null || userData.password == null || userData.name == null || userData.accType == null
                ...
                var data = { username: userData.username, pass: userData.password,
                ...
                _this.http.post(_this.signupURL, req, options).subscribe(function (res) {
    ...
    AuthServiceProvider.prototype.login = function (userData) {
        ...
        return new Promise(function (resolve, reject) {
            if (userData.username == null || userData.password == null) {
                ...
                _this.http.post(_this.loginURL, req, options).subscribe(function (res) {
                    var response = res.json();
                    console.log("response: " + response);
                    if (response == null) {
                        ...
                        _this.storage.set('name', response[0].name);
                        _this.storage.set('email', response[0].email);
                        _this.storage.set('pic', response[0].pic);
                        _this.event.publish('user:logged', response[0], Date.now());
                        if (response[0].accType == "SO") {
                            _this.enableAuthenticatedMenuForOwner();
                        }
                        else {
    ...
    AuthServiceProvider.prototype.fbLogin = function () {
        var _this = this;
    ...
    AuthServiceProvider.prototype.enableAuthenticatedMenu = function () {
        this.menuCtrl.enable(true, 'authenticated');
        this.menuCtrl.enable(false, 'unauthenticated');
        this.menuCtrl.enable(false, 'authenticatedOwner');
    };
    AuthServiceProvider.prototype.enableAuthenticatedMenuForOwner = function () {
...
AuthServiceProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__ionic_native_keyboard__["a" /* Keyboard */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_facebook__["a" /* Facebook */], __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_5__angular_http__["b" /* Http */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* MenuController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
], AuthServiceProvider);
...
var map = {
	"../pages/createspace/createspace.module": [
		445,
		1
	],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_view_image_view_image__ = __webpack_require__(295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_login_login__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_map_map__ = __webpack_require__(294);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ionic_native_facebook__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_keyboard__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__ionic_native_firebase__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_splash_splash__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ionic_native_network__ = __webpack_require__(213);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__ionic_native_photo_viewer__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__ionic_native_geolocation__ = __webpack_require__(214);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__ionic_native_local_notifications__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__ionic_storage__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25_firebase__ = __webpack_require__(370);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__providers_auth_service_auth_service__ = __webpack_require__(154);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* MyApp */], {}, {
                links: [
                    ...
                    { loadChildren: '../pages/createspace/createspace.module#CreatespacePageModule', name: 'CreatespacePage', segment: 'createspace', priority: 'low', defaultHistory: [] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_splash_splash__ = __webpack_require__(156);
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, modalCtrl, storage, events, menuCtrl) {
        ...
        events.subscribe('user:logged', function (user, time) {
            console.log('Welcome', user, 'at', time);
            if (user.accType == "SO") {
                _this.authenticatedOwner.push({ title: user.email, component: " " });
                _this.authenticatedOwner.push({ title: 'Logout', component: null });
            }
            else {
                _this.authenticatedPages.push({ title: user.email, component: " " });
                _this.authenticatedPages.push({ title: 'Logout', component: null });
            }
        });
    }
...
MyApp = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */], __WEBPACK_IMPORTED_MODULE_7__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* Events */],
